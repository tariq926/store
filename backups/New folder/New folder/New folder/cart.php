...
$recommended_products = getPersonalizedRecommendations($pdo, $_SESSION['user_id']);

// Calculate potential loyalty discount
$loyalty_discount = applyLoyaltyDiscount($pdo, $_SESSION['user_id']);

// Send cart reminder
sendCartReminderNotification($pdo, $_SESSION['user_id']);
...
<body>
    ...
    <?php if (isset($_SESSION['wishlist_message'])): ?>
        <div class="message"><?php echo $_SESSION['wishlist_message']; unset($_SESSION['wishlist_message']); ?></div>
    <?php endif; ?>
        ...
        <div class="recommendation-grid">
            <?php foreach ($recommended_products as $product): ?>
                <div class="recommendation-item">
                    ...
                    <p>KSH <?php echo htmlspecialchars($product['price_ksh']); ?></p>
